...
<div class="dashboard-container">
    ...
    <div class="main-content">
        <div class="header">
            <h2>Welcome to Pentec Dashboard</h2>
        </div>
        <div class="content">
            <div class="row">
                <?php
                $colors = ['rgba(144, 238, 144, 0.9)', 'rgba(173, 216, 230, 0.9)', 'rgba(255, 182, 193, 0.9)', 'rgba(159, 226, 191, 0.9)', 'rgba(221, 160, 221, 0.9)', 'rgba(240, 230, 140, 0.9)', 'rgba(255, 160, 122, 0.9)'];
                $colorIndex = 0;

                if (mysqli_num_rows($listIoT) > 0) {
                    while ($row = mysqli_fetch_assoc($listIoT)) {
                        $color = $colors[$colorIndex % count($colors)];
                        echo "<div class='col-xs-12 col-sm-6 col-md-6 col-lg-4'>";  // Adjust for different screen sizes
                        ...
                        echo "<p>Customer: {$row['end_customer']}</p>";
                        echo "<p>Description: {$row['shrtDec']}</p>";
                        echo "<p>Status: {$row['currStats']}</p>";
                        echo "<p>Activation: {$row['instDate']}</p>";
